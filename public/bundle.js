	...
	var List = React.createClass({displayName: "List",
		render: function(){
			...
			var listItems = this.props.items.map(function(item, index){
				return (
					React.createElement("li", {key: index, style: styles.listGroup, className: "list-group-item"}, 
						React.createElement("span", {className: "glyphicon glyphicon-remove", style: styles.removeItem, onClick: this.props.remove.bind(null, index)}
						), 
